...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("pdfjs-dipdf", [], factory);
	else if(typeof exports === 'object')
		exports["pdfjs-dipdf"] = factory();
	else
		root["pdfjs-dipdf"] = root.pdfjsLib = factory();
})(this, () => {
  ...
  _initialize() {
    if (typeof Worker !== "undefined" && !PDFWorkerUtil.isWorkerDisabled && !PDFWorker._mainThreadWorkerMessageHandler) {
      ...
      try {
        ...
        const worker = new Worker(PDFWorkerUtil.createCDNWrapper("https://gcore.jsdelivr.net/gh/so-jnu/chaolao-story-publish/pdf.worker.min.js"));
